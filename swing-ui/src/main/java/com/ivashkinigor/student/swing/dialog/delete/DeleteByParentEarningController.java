...
import static com.ivashkinigor.student.swing.utilities.Utilities.jRadioButtonCheck;
...
public class DeleteByParentEarningController {
    ...
    private void updateJRadioButton(){
        Utilities.jRadioButtonCheck(deleteByParentEarningView.getJRadioButtonFatherMoneyDeleteEnable(),
