...
public class DeleteByCountOfBrothersAndSistersView extends JFrame {
    ...
    public DeleteByCountOfBrothersAndSistersView(StudentTable studentTable) {
        super();
        setVisible(false);
    ...
    public void initialize(){
        ...
        new DeleteByCountOfBrothersAndSistersController(this,studentTable.getStudentModel());
    }
