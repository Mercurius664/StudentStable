...
public class FindByCountOfBrothersAndSistersView extends JFrame{
    ...
    public static FindByCountOfBrothersAndSistersView getInstance() {
        if (findByCountOfBrothersAndSistersView == null){
            findByCountOfBrothersAndSistersView = new FindByCountOfBrothersAndSistersView();
        }
        return findByCountOfBrothersAndSistersView;
    }

    public FindByCountOfBrothersAndSistersView() {
        super();
        setVisible(false);
    ...
    public void initialize(){
        ...
        FindByCountOfBrothersAndSistersController.getInstance();
    }
