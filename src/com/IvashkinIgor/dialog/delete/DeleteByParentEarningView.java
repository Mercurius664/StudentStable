...
public class DeleteByParentEarningView extends JFrame{
    ...
    public static DeleteByParentEarningView getInstance() {
        if (deleteByParentEarningView == null){
            deleteByParentEarningView = new DeleteByParentEarningView();
        }
        return deleteByParentEarningView;
    }

    private DeleteByParentEarningView() {
        super();
        setVisible(false);
    ...
    public void initialize(){
        ...
        DeleteByParentEarningController.getInstance();
    }
