...
public class DeleteByParentNameView extends JFrame {
    ...
    private static DeleteByParentNameView deleteByParentNameView;

    public static DeleteByParentNameView getInstance() {
        if (deleteByParentNameView == null){
            deleteByParentNameView = new DeleteByParentNameView();
        }
        return deleteByParentNameView;
    }

    private DeleteByParentNameView() {
        super();
        setVisible(false);
    ...
    public void initialize(){
        ...
        DeleteByParentNameController.getInstance();
    }
